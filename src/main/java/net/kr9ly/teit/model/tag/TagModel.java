 ...
 */
public abstract class TagModel extends AbstractModel {

    private Token tagNameToken;

    public TagModel(Token tagNameToken) {
        this.tagNameToken = tagNameToken;
    }

    public boolean isMatchCloseTag(String closeTagName) {
        return tagNameToken.getTokenString().equals(closeTagName);
    }
}
